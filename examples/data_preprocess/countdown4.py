...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='~/verl/data/countdown4')
    ...
    try:
        ...
        local_data_source = f"{os.environ.get('HOME')}/verl/data/countdown4/raw/data"
        if not os.path.exists(local_data_source):
            os.system('pip install -U huggingface_hub; export HF_ENDPOINT=https://hf-mirror.com; huggingface-cli download --repo-type dataset --resume-download Jiayi-Pan/Countdown-Tasks-4 --local-dir data/countdown4/raw')
